...
import (
	...
	"github.com/jiujiu532/Resin/internal/geoip"
	"github.com/jiujiu532/Resin/internal/metrics"
	"github.com/jiujiu532/Resin/internal/model"
	"github.com/jiujiu532/Resin/internal/netutil"
	...
	"github.com/jiujiu532/Resin/internal/proxy"
	"github.com/jiujiu532/Resin/internal/requestlog"
	"github.com/jiujiu532/Resin/internal/routing"
...
func newTopologyRuntime(
	...
	pool.SetOnNodeAdded(func(hash node.Hash) {
		...
		// No NotifyNodeDirty here â€?AddNodeFromSub already notifies all platforms.
...
// Steps: static nodes â†?subscription bindings â†?dynamic state â†?latency tables.
func bootstrapNodes(
	engine *state.StateEngine,
	pool *topology.GlobalNodePool,
	subManager *topology.SubscriptionManager,
