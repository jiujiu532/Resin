...
type ApiPlatform = Omit<Platform, "regex_filters" | "region_filters"> & {
  ...
  subscription_sources?: string[] | null;
...
function normalizePlatform(raw: ApiPlatform): Platform {
  return {
    ...
    subscription_sources: Array.isArray(raw.subscription_sources) ? raw.subscription_sources : [],
    blocked_node_hashes: Array.isArray((raw as any).blocked_node_hashes) ? (raw as any).blocked_node_hashes : [],
